    ...
    <div className="p-8">
      ...
      <section className="mt-10">
        ...
        <ul className="mt-4 space-y-2">
          ...
          <li className="flex items-center"><DropletIcon className="w-5 h-5 mr-2" /> Irrigation Systems</li>
          <li className="flex items-center"><AdjustmentsHorizontalIcon className="w-5 h-5 mr-2" /> Tree Trimming & Removal</li>
          <li className="flex items-center"><LeafIcon className="w-5 h-5 mr-2" /> Mulching & Sodding</li>
        </ul>
      </section>
