...
import { SparklesIcon, CubeIcon, ScissorsIcon, DropletIcon, AdjustmentsHorizontalIcon, LeafIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="p-8">
      ...
      <ul className="mt-4 space-y-2">
        ...
        <li className="flex items-center"><LeafIcon className="w-5 h-5 mr-2" /> Weed Control & Prevention</li>
        ...
        <li className="flex items-center"><DropletIcon className="w-5 h-5 mr-2" /> Irrigation Maintenance & Repair</li>
        <li className="flex items-center"><LeafIcon className="w-5 h-5 mr-2" /> Sod Installation & Lawn Restoration</li>
